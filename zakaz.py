...
mainlabel = Label(m, text = 'Компания «Премьер Зал» появилась в 1998 году,'
                            ...
                            '\nспециальной технологии. ', font = ('Helvetica', 12), bg=wh, width=45, justify='left')
...
mainlabel1 = Label(m, text = 'В наших кинотеатрах можно не просто посмотреть '
                             ...
                             '\nконцерты и лекции, проводим фестивали', font = ('Helvetica', 12), bg=wh, width=46, justify='left')
...
mainlabel2 = Label(m, text = 'мастер-классы, клубы по интересам.'
                             ...
                             '\n создать комфортные условия.', font = ('Helvetica', 12), bg=wh, width=42, justify='left')
