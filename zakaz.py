...
mainlabel = Label(m, text = 'Компания «Премьер Зал» появилась в 1998 году,'
                            ...
                            '\nспециальной технологии. ', font = ('Calibri', 12), bg=wh, width=45, justify='left')
mainlabel.place(x=70, y =800)
mainlabel1 = Label(m, text = 'В наших кинотеатрах можно не просто посмотреть '
                             '\nкинов хорошем качестве, но и перекусить '
                             ...
                             '\nконцерты и лекции, проводим фестивали', font = ('Calibri', 12), bg=wh, width=46, justify='left')
mainlabel1.place(x=450, y =800)
mainlabel2 = Label(m, text = 'мастер-классы, клубы по интересам.'
                             ...
                             '\nЗадача «Премьер Зала» – обеспечить наших гостей'
                             '\nкачественным и интересным досугом, создать'
                             '\nкомфортные условия для культурного отдыха. ', font = ('Calibri', 12), bg=wh, width=45, justify='left')
mainlabel2.place(x= 840, y =800)
